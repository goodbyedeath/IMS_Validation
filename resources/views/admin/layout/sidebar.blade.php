<div class="main-sidebar">
    <aside id="sidebar-wrapper">
        <div class="sidebar-brand text text-center">
            <img src="{{ asset('front/logo/logo-ims.png') }}" class="img-thumbnail" alt="">
        ...
        <ul class="sidebar-menu">
            ...
            <li class="{{ Request::is('admin/table/*') ? 'active':'' }}"><a class="nav-link" href="{{ route('admin_table_index') }}"><i class="fas fa-hand-point-right"></i> <span>Companies Table</span></a></li>
